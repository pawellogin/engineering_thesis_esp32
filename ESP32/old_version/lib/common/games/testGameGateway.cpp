...
void testGameGatewayOnFinish(Game *g)
{
    ...
    // TODO for creating messageDTO i have to make be a helper function
    UdpMessageDTO msg;
...
bool testGameGatewayShouldEnd(Game *g)
{
    // TODO add logic that if the score is above 5 for any esp send end game message
    return false;
}
...
void testGameGatewaySetup()
{
    ...
    espTestGameGateway.base.duration = 15000; // 15 seconds
    ...
    espTestGameGateway.base.shouldEnd = testGameGatewayShouldEnd;
}
