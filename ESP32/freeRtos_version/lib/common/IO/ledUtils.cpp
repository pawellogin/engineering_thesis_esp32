...
{
    ColorEnum defaultColor = getDefaultColorForBoard(BOARD_ID);

    switch (state)
    {
    case ClientState::STATE_SETUP:
        ledStripClear(ledStrip);
        ledStripShowColor(ledStrip, defaultColor);
        break;
    case ClientState::STATE_WAITING_FOR_CONNECTION:
        ledStripAnimStart(ledStrip, defaultColor, 50);
        break;
    case ClientState::STATE_WAITING_FOR_ACKNOWLEDGE:
        ledStripAnimStart(ledStrip, defaultColor, 10);
        break;
    ...
    case ClientState::STATE_READY:
        ledStripAnimStart(ledStrip, defaultColor, 1000);
        break;
